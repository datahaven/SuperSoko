...
bool AppDelegate::initInstance()
{
    ...
    do
    {
		...
		// The Soko is designed as HVGA.
		CCEGLView * pMainWnd = new CCEGLView();
		CC_BREAK_IF(! pMainWnd
				//|| ! pMainWnd->Create(TEXT("Super Sokoban"), 480, 320));
				|| ! pMainWnd->Create(TEXT("Super Soko"), 960, 640)); // Retina sized
		...
		// OpenGLView initialized in Soko/android/jni/Soko/main.cpp
		...
		cocos2d::CCFileUtils::setResource("Soko.zip");
#endif
